document.addEventListener('DOMContentLoaded', function() {
    ...
    // Restaurar el contenido del textarea al cargar el panel
    ...
    console.log('SidePanel DOM cargado INSSSEP');
    ...
    // Cargar listado desde memoria al abrir el panel
    ...
    // Función para ir al siguiente paciente
    ...
    // Función para ir al paciente anterior
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if (e.target.tagName === 'INPUT' || e.target.tagName === 'TEXTAREA') {
            // Permitir Ctrl+Enter desde inputs para rellenar
        ...
        // Ctrl + ← : Paciente anterior
        if (e.ctrlKey && e.key === 'ArrowLeft') {
            e.preventDefault();
            anteriorPaciente();
        }
        // Ctrl + → : Paciente siguiente
        if (e.ctrlKey && e.key === 'ArrowRight') {
            e.preventDefault();
            siguientePaciente();
        }
        // Ctrl + Enter : Rellenar formulario
        if (e.ctrlKey && e.key === 'Enter') {
            e.preventDefault();
            rellenarFormulario();
        }
    ...
    // Función para rellenar formulario (usada por atajo de teclado)
